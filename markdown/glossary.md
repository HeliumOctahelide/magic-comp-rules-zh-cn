...
参见规则[113](./1#cr113)，“异能”，和[第6章](6)，“咒语、异能和效应”。   
...
一个斜体的词，没有规则上的意义，将不同牌上类似作用的异能联系起来。参见规则[207.2c](./2#cr207-2c)。   
...
将一个起动式异能放进堆叠并支付其费用，使它最终能够结算并产生效应。参见规则[602](./6#cr602)，“起动起动式异能”。   
...
一种异能。起动式异能的格式为“[费用]：[效应]。[起动限制（如果有的话）]”。参见规则[113](./1#cr113)，“异能”，以及规则[602](./6#cr602)，“起动起动式异能”。   
...
一个起动式异能叙述中冒号之前的部分。必须支付它来起动该异能。参见规则[118](./1#cr118)，“费用”，以及规则[602](./6#cr602)，“起动起动式异能”。   
...
主动牌手指轮到该回合的牌手。参见规则[102.1](./1#cr102-1)。   
...
一个在多人同时需要作出选择时，用来决定牌手作出选择顺序的系统。参见规则[101.4](./1#cr101-4)。本规则在队伍共享回合模式中有变更；参见规则[805.6](./8#cr805-6)。   
...
主动队伍指在队伍共享回合模式下，轮到该回合的队伍。参见规则[805.4a](./8#cr805-4a)。   
...
一个关键字动作，在牌手没有+1/+1指示物的生物上放置+1/+1指示物。参见规则[701.43](./7#cr701-43)，“演化”。   
...
一张分为两部分（且其中一部分是嵌在文字栏左面）的牌，其副特征包括历险此咒语类别。。参见规则[715](./7#cr715)，“历险者牌”。   
...
一个关键字异能，使防御牌手阻挡时失去生命。参见规则[702.130](./7#cr702-130)，“折磨”。   
...
一个关键字异能，使某些生物死去时留下精怪衍生生物。参见规则[702.135](./7#cr702-135)，“往生”。   
...
一个关键字异能，使牌手能且仅能从其坟墓场中施放一张连体牌的其中一边。参见规则[702.127](./7#cr702-127)，“余响”。   
...
咒语可能具有的费用，其操控者可以选择支付该费用而不是其法术力费用。参见规则[118](./1#cr118)，“费用”，以及规则[601](./6#cr601)，“施放咒语”。   
...
一个关键字异能，可以令生物于进入战场时具有+1/+1指示物。参见规则[702.38](./7#cr702-38)，“增强”。   
...
于永久物进战场时可能选择的两个词语之一，出现在异能的开头。参见规则[614.12b](./6#cr614-12b)。   
...
一个咒语或异能可能需要“任意一个目标”。“任意一个目标”等同于“目标生物、牌手或鹏洛客”。参见规则[115.4](./1#cr115-4)。   
...
一个既是神器又是生物的组合，两者的规则对它都有效。参见规则[301](./3#cr301)，“神器”，以及规则[302](./3#cr302)，“生物”。   
...
一个既是神器又是地的组合，两者的规则对它都有效。神器地只能作为地来使用，而不能作为咒语施放。参见规则[301](./3#cr301)，“神器”，以及规则[305](./3#cr305)，“地”。   
...
一个叙述，用来表示游戏由于一些特殊的原因，即使在某条件不符合的情况下按照符合的情况对待。参见规则[609.4](./6#cr609-4)。   
...
一个关键字异能，允许另一位牌手帮助你支付咒语的费用。参见规则[702.132](./7#cr702-132)，“助力”。   
...
一个印在异能上的触发条件，在结束步骤开始时触发（而不是一个回合最后发生的事）。印有此叙述的牌已经在Oracle牌张参考文献中得到了勘误，新叙述为“在结束步骤开始时”或“在下一个结束步骤开始时”。参见规则[513](./5#cr513)，“结束步骤”。   
...
将一个灵气、武具或工事从其当前所在位置拿开，并将其放置到一个指定物件或牌手上。参见规则[701.3](./7#cr701-3)，“贴附”。   
...
一个生物在战斗阶段中被合法宣告为攻击的一部分（如果有攻击的费用，则在支付之后），或一个生物被放进战场且进行攻击。它在被移出战斗或战斗阶段结束两者中最先发生的之前，都保持为进行攻击的生物。参见规则[508](./5#cr508)，“宣告攻击者步骤”。   
...
一副可选套牌，包含至少三张（在限制赛中）或十张（在构组赛中）景点牌，在用到Unfinity系列中某些卡牌的游戏中使用。参见规则[717.2](./7#cr717-2)。   
...
一个结界的副类别。灵气咒语以物件或牌手为目标，且灵气永久物贴附于物件或牌手上。参见规则[303](./3#cr303)，“结界”，以及规则[702.5](./7#cr702-5)，“结附”。   
...
一个关键字异能，让你将一个手上的灵气与战场上的交换。参见规则[702.65](./7#cr702-65)，“灵气转换”。   
...
一个关键字异能，让你将一个由你操控的地变成生物。参见规则[702.113](./7#cr702-113)，“醒转”。   
...
一个关键字异能，让其他攻击生物在战斗中更强。参见规则[702.91](./7#cr702-91)，“战嚎”。   
...
一个区域。战场是永久物存在的区域。此区域过去被称为“场上”区域。参见规则[403](./4#cr403)，“战场”。   
...
回合的一部分。这是回合的第一个阶段。参见规则[501](./5#cr501)，“开始阶段”。   
...
回合的一部分。这是战斗阶段的第一个步骤。参见规则[507](./5#cr507)，“战斗开始步骤”。   
...
一个关键字动作，允许牌手选择一个由其操控且具有特定特征的永久物，或从手上展示一张具有该特征的牌，通常是为了支付费用或获得额外效应。参见规则[701.61](./7#cr701-61)，“请援”。   
...
一个关键字异能，让生物牌可以作为灵气施放。参见规则[702.103](./7#cr702-103)，“神授”。   
...
将一个生物以防守的形态送进战斗。生物可以阻挡攻击生物。参见规则[509](./5#cr509)，“宣告阻挡者步骤”。   
...
一个生物在战斗阶段中被合法宣告为阻挡的一部分（如果有阻挡的费用，则在支付之后），或一个生物被放进战场且进行阻挡。它在被移出战斗或战斗阶段结束两者中最先发生的之前，都保持为进行阻挡的生物。参见规则[509](./5#cr509)，“宣告阻挡者步骤”。   
...
血滴衍生物是具有“{1}，{T}，弃一张牌，牺牲此神器：抓一张牌”的无色衍生神器。欲知关于预定义衍生物的更多信息，参见规则[111.10](./1#cr111-10)。   
...
一个关键字异能，可以让生物进入战场时带有+1/+1指示物。参见规则[702.54](./7#cr702-54)，“嗜血”。   
...
一类特殊的起动式异能，如果具炫威异能的生物攻击过便可起动，且每回合只能起动一次。参见规则[702.142](./7#cr702-142)，“炫威”。   
...
一个关键字动作，在牌手操控的最弱的生物上放置+1/+1指示物。参见规则[701.33](./7#cr701-33)，“振励”。   
...
指挥官休闲玩法的一种模式。参见规则[903.12](./9#cr903-12)，“争锋模式”。   
...
一个关键字异能，让生物在战斗中更强。参见规则[702.45](./7#cr702-45)，“武士道”。   
...
游戏的标准组成部分。万智牌可以是传统或非传统。衍生物不被视为牌。在咒语或异能的叙述中，“牌”一词只被用来表示不在战场或堆叠中的牌，比如牌手手上的生物牌。参见规则[108](./1#cr108)，“牌”。   
...
一个关键字异能，可能让牌手不付费用施放一个随机的额外咒语。参见规则[702.85](./7#cr702-85)，“倾曳”。   
...
将一张牌从当前的位置（一般在手上）放进堆叠，并支付其费用，让它最终可以结算并产生效果。参见规则[601](./6#cr601)，“施放咒语”。   
...
一种静止式异能，包含物件一般情况下在该物件其他部分才能找到的特征信息（比如法术力费用，类别栏，或力量/防御力框）。参见规则[604.3](./6#cr604-3)。   
...
定义一个物件的信息。参见规则[109.3](./1#cr109-3)。   
...
拍档异能的一种变化形式。在指挥官玩法中，如果两张传奇永久物牌其中之一具有“选择身世”异能，另一张是身世结界牌，则可将这两个传奇永久物用作你的指挥官，而非只使用一个。参见规则[702.124](./7#cr702-124)，“拍档”，及规则[903](./9#cr903)，“指挥官”。   
...
一种结界的副类别。职业具有数个职业等级异能，可以提升其等级并赋予其新异能。参见规则[716](./7#cr716)，“职业牌”。   
...
回合的一部分。此步骤是终结阶段的第二个也是最后一个步骤。参见规则[514](./5#cr514)，“清除步骤”。   
...
一个关键字动作，将牌以牌面朝下的方式作为2/2、具守护{2}的生物放进战场。参见规则[701.56](./7#cr701-56)，“匿伏”，和规则[708](./7#cr708)，“牌面朝下的咒语和永久物”。   
...
线索衍生物是具有“{2}，牺牲此神器：抓一张牌。”的无色衍生神器。欲知关于预定义衍生物的更多信息，参见规则[111.10](./1#cr111-10)。   
...
印在绝大多数牌上对游戏没有影响的编号。参见规则[213](./2#cr213)，“文字栏下方信息”。   
...
1. 物件的一个特征。参见规则[105](./1#cr105)，“颜色”，以及规则[202](./2#cr202)，“法术力费用和颜色”。   
1. A characteristic of an object. See rule 105, “Colors,” and rule 202, “Mana Cost and Color.”

2. 一个法术力可能具有的特征。参见规则[106](./1#cr106)，“法术力”。   
...
物件的一个特征。参见规则[105](./1#cr105)，“颜色”，以及规则[204](./2#cr204)，“颜色标志”。   
...
回合的一部分。此步骤是战斗阶段的第四个步骤。参见规则[510](./5#cr510)，“战斗伤害步骤”。   
...
回合的一部分。此阶段是回合的第三个阶段。参见规则[506](./5#cr506)，“战斗阶段”。   
...
一些对游戏有总体影响且当前不是永久物也不能被消灭的特殊物件所在的区域。参见规则[408](./4#cr408)，“统帅区”。   
...
1. 一种休闲式玩法，套牌由一个传奇生物来领导。参见规则[903](./9#cr903)，“指挥官”。   
...
一种休闲玩法，牌手参加补充包轮抽，然后进行多人游戏。参见规则[903.13](./9#cr903-13)，“指挥官轮抽”。   
...
忍术异能的一种变化。参见规则[702.49](./7#cr702-49)，“忍术”。   
...
一个非正式用词，意指施放指挥官的额外费用，此费用会根据牌手于这盘游戏先前的时段中施放过指挥官的次数决定。参见规则[903.8](./9#cr903-8)。   
...
一个关键字异能，允许牌手从游戏外选择一张生物牌作为行侣（如果能满足该牌的行侣异能限制的话）。一旦牌手选定行侣，该牌手可以在游戏中支付一次{3}，将其置于手上。参见规则[702.139](./7#cr702-139)，“行侣”。   
...
一个关键字异能，若牌手施放鹏洛客时选择为其费用中的非瑞克西亚法术力符号支付生命，则使其进战场时带有较少的忠诚指示物。参见规则[702.150](./7#cr702-150)，“完化”。   
...
在达到地城牌的最底下的房间之后，将该地城牌移出游戏。参见规则[309](./3#cr309)，“地城”。   
...
离开游戏。认输游戏让牌手立刻离开游戏并输去游戏。参见规则[104](./1#cr104)，“结束游戏”。   
...
一个关键字异能，让生物可以复制咒语。参见规则[702.78](./7#cr702-78)，“协力”。   
...
为在该牌手作出由规则或物件允许或要求的所有选择和决定。参见规则[721](./7#cr721)，“操控其他牌手”。   
...
将一张双面牌翻转从而让其另一面朝上。参见规则[701.50](./7#cr701-50)，“转换”。   
...
一个关键字异能，让你横置生物来施放咒语而不是支付法术力。参见规则[702.51](./7#cr702-51)，“召集”。   
...
物件由复制效应所检查的特征值。参见规则[613.2](./6#cr613-2)、[707.2](./7#cr707-2)以及[707.3](./7#cr707-3)。   
...
派出一个衍生物指，将一个衍生物放进战场。参见规则[701.6](./7#cr701-6)，“派出”。   
...
将对手，任何由其操控的东西和／或其坟墓场中的牌指定为目标，即属罪行。参见规则[700.13](./7#cr700-13)。   
...
一个关键字异能，为保留永久物在战场上规定了一个不断提升的费用。参见规则[702.24](./7#cr702-24)，“累积维持”。   
...
一个关键字异能，让牌可以被弃掉并用新牌代替。参见规则[702.29](./7#cr702-29)，“循环”。   
...
物件可以对生物、鹏洛客、以及牌手造成“伤害”。一般情况下这对受到伤害的物件或牌手来说是不利的。参见规则[120](./1#cr120)，“伤害”。   
...
一个见于生物牌上的关键字异能，允许其使用替代性费用来施放。参见规则[702.109](./7#cr702-109)，“掩袭”。   
...
与黑夜一起，均是游戏可以具有的称号。参见规则[729](./7#cr729)，“白昼与黑夜”，与规则[702.145](./7#cr702-145)，“昼形与夜形”。   
...
一种异能，见于一些双面牌的正面上。具昼形与夜形异能的牌，在白昼时正面朝上，在黑夜时背面朝上。参见规则[702.145](./7#cr702-145)，“昼形与夜形”，与规则[729](./7#cr729)，“白昼与黑夜”。   
...
一个关键字异能，让物件造成的伤害特别有效。参见规则[702.2](./7#cr702-2)，“死触”。   
...
选择将进行攻击的一组生物，宣告每个生物攻击防御牌手或该牌手操控的一个鹏洛客，并且支付允许这些生物攻击所要求的任何费用。参见规则[508.1](./5#cr508-1)。   
...
回合的一部分。该步骤是战斗阶段的第二个步骤。参见规则[508](./5#cr508)，“宣告攻击者步骤”。   
...
选择将进行阻挡的一组生物，为每个生物宣告将阻挡那个攻击生物，并支付允许这些生物阻挡所要求的任何费用。参见规则[509.1](./5#cr509-1)。   
...
回合的一部分。该步骤是战斗阶段的第三个步骤。参见规则[509](./5#cr509)，“宣告阻挡者步骤”。   
...
一个关键字异能，让某个生物不能进行攻击。参见规则[702.3](./7#cr702-3)，“守军”。   
...
当一些咒语或异能结算时所创造的效应所创造的异能，或当一些替代性效应生效时，不是在当时而是在之后作某些事情。参见规则[603.7](./6#cr603-7)。   
...
一个关键字异能，让你从你的坟墓场中放逐牌来施放咒语，而不是支付一般法术力。参见规则[702.66](./7#cr702-66)，“掘穴”。   
...
一些咒语上的触发式异能，使其操控者复制之，并选择一个对手亦复制之。参见规则[702.144](./7#cr702-144)，“示范”。   
...
将一个永久物从战场移动到其拥有者的坟墓场。参见规则[701.7](./7#cr701-7)，“消灭”。   
...
一个关键字异能，临时阻止一个永久物攻击、阻挡，或起动其具有的起动式异能。参见规则[701.29](./7#cr701-29)，“拘留”。   
...
一个关键字异能，具有该异能的生物在攻击生命值最多的牌手时，会在生物上放置一个+1/+1指示物。参见规则[702.105](./7#cr702-105)，“义勇”。   
...
一个特征定义异能，使物件成为无色。参见规则[702.114](./7#cr702-114)，“虚色”。   
...
一个牌手具有的数字，等同于该牌手操控的永久物之法术力费用中，某种特别颜色的法术力符号数量。参见规则[700.5](./7#cr700-5)。   
...
一个关键字异能，可以让生物进入战场带有+1/+1指示物。参见规则[702.82](./7#cr702-82)，“吞噬”。   
...
如果一个生物或鹏洛客从战场进入坟墓场，该生物或鹏洛客“死去”。参见规则[700.4](./7#cr700-4)。   
...
从拥有者的手上将牌移入该牌手的坟墓场。参见规则[701.8](./7#cr701-8)，“弃牌”。   
...
一个关键字异能，允许牌手不付费用施放一个随机咒语。参见规则[701.55](./7#cr701-55)，“倾探”。（译注：我确信这是一个关键字动作。）   
...
一个关键字异能，允许该牌以牌面朝下的方式，且视为2/2、具守护{2}的生物一般施放。参见规则[702.168](./7#cr702-168)，“伪装”，和规则[708](./7#cr708)，“牌面朝下的咒语和永久物”。   
...
一个关键字异能，允许牌手从坟墓场以已转化的方式施放双面牌。参见规则[702.146](./7#cr702-146)，“惊扰”。   
...
一个关键字异能，让生物造成两次战斗伤害。参见规则[702.4](./7#cr702-4)，“连击”。   
...
两面都具有牌面的牌，并且没有万智牌牌背。参见规则[712](./7#cr712)，“双面牌”。   
...
轮抽过程的一部分，在此过程中每位牌手打开一个未打开的补充包，然后牌手们抽选这些牌。参见规则[905.1a](./9#cr905-1a)和[905.1b](./9#cr905-1b)。   
...
1. 作为回合动作或一个效应的结果，将牌手的牌库顶牌放进其手上，使用“抓”一词。参见规则[121](./1#cr121)，“抓牌”。   
...
2. 没有牌手输或赢的游戏结局。参见规则[104.4](./1#cr104-4)。   
...
回合的一部分。该步骤是开始阶段的第三个也是最后一个步骤。参见规则[504](./5#cr504)，“抓牌步骤”。   
...
作为咒语或异能的结论在游戏中发生。参见规则[609](./6#cr609)，“效应”。   
...
一个关键字异能，使牌手从其坟墓场中放逐一张生物牌，来派出该牌化身为木乃伊的衍生物版本。参见规则[702.128](./7#cr702-128)，“遗存”。   
...
回合的一部分。此步骤是终结阶段的第一个步骤。参见规则[513](./5#cr513)，“结束步骤”。   
...
回合的一部分。此步骤是战斗阶段的第五个步骤也是最后一个步骤。参见规则[511](./5#cr511)，“战斗结束步骤”。   
...
作为一个效应的结果来“结束战斗阶段”指，进行一个快速的流程来略过该阶段将发生的所有其他事情。参见规则[722](./7#cr722)，“结束回合和阶段”。   
...
作为一个效应的结果来“结束回合”指，进行一个快速的流程来略过该回合将发生的所有其他事情。参见规则[722](./7#cr722)，“结束回合和阶段”。   
...
回合的一部分。此阶段是回合的第五个也是最后一个阶段。参见规则[512](./5#cr512)，“终结阶段”。   
...
一个关键字异能，让你选择在生物上放置+1/+1指示物或派出精怪衍生生物。参见规则[702.62](./7#cr702-62)，“续战”。（译注：我确信这是一个关键字动作。）   
...
一个关键字异能，允许一个能够攻击的生物协助另一个生物。参见规则[702.154](./7#cr702-154)，“征列”。   
...
一个关键字异能，让牌手在他的每个维持开始时都复制该咒语，但要付出该盘游戏余下的部分不能施放其他咒语的代价。参见规则[702.50](./7#cr702-50)，“历传”。   
...
一个关键字异能，让牌手将武具贴附于他所操控的生物上。参见规则[301](./3#cr301)，“神器”以及规则[702.6](./7#cr702-6)，“佩带”。   
...
一个神器副类别。武具可以贴附于生物上。参见规则[301](./3#cr301)，“神器”以及规则[702.6](./7#cr702-6)，“佩带”。   
...
一个关键字异能，让一些具有模式的咒语可以付费选择额外的模式。参见规则[702.120](./7#cr702-120)，“增效”。   
...
一个关键字异能，使牌手能从其坟墓场施放一张牌。参见规则[702.138](./7#cr702-138)，“逸脱”。   
...
一个关键字异能，使牌手从其坟墓场中放逐一张生物牌，并派出一个该牌的永生衍生物版本。参见规则[702.129](./7#cr702-129)，“永生”。   
...
游戏中发生的任何事。参见规则[700.1](./7#cr700-1)。   
...
一个关键字异能，每当一个更大的生物在你的操控下进入战场时，让你将+1/+1指示物放在生物上。参见规则[702.100](./7#cr702-100)，“进化”。   
...
一个关键字异能，让生物在战斗中更好。参见规则[702.83](./7#cr702-83)，“颂威”。   
...
一个关键字异能，使你通过牺牲生物来获得优势。参见规则[702.110](./7#cr702-110)，“榨取”。   
...
一个关键字动作，使牌手展示其牌库顶牌，然后根据展示的牌是否是地牌采取不同的动作。参见规则[701.40](./7#cr701-40)，“勘察”。   
...
一个关键字异能，每当你施放咒语时让你得到生命并且让对手失去生命。参见规则[702.101](./7#cr702-101)，“敲诈”。   
...
一个关键字异能，让你选择派出自动机衍生物或者在生物上放置+1/+1指示物。参见规则[702.123](./7#cr702-123)，“装配”。   
...
2. 永久物可能拥有的一个状态。参见规则[110.5](./1#cr110-5)以及[702.37](./7#cr702-37)，“变身”。   
2. A status a permanent may have. See rule 110.5 and rule 702.37, “Morph.”

3. 牌面朝下的咒语具有额外规则。参见规则[708](./7#cr708)，“牌面朝下的咒语和永久物”，以及规则[702.37](./7#cr702-37)，“变身”。   
...
一个关键字动作，使牌手在两个列出的选项中选择一项。参见规则[701.53](./7#cr701-53)，“面临邪恶抉择”。   
...
一个关键字异能，限制一个永久物能够留在战场上的时间。参见规则[702.32](./7#cr702-32)，“消退”。   
...
操纵对手牌库顶的一些牌。参见规则[701.22](./7#cr701-22)，“论命”。   
...
一个关键字异能，限制一个生物能如何被阻挡。参见规则[702.36](./7#cr702-36)，“恐惧”。   
...
一种指示物，在永久物将从战场进入坟墓场时改为放逐之。参见规则[122.1h](./1#cr122-1h)。   
...
一个关键字异能，让生物在其他生物之前造成其战斗伤害。参见规则[702.7](./7#cr702-7)，“先攻”。   
...
一个关键字异能，让牌手在任何其可以施放瞬间的时候使用一张牌。参见规则[702.8](./7#cr702-8)，“闪现”。   
...
一个永久物可能具有的状态。参见规则[110.5](./1#cr110-5)以及规则[710](./7#cr710)，“倒转牌”。另参见未倒转。   
...
一个随机决定两个相同可能性结果的方法。参见规则[705](./7#cr705)，“掷硬币”。   
...
食品衍生物是具有“{2}，{T}，牺牲此神器：你获得3点生命”的无色衍生神器。欲知关于预定义衍生物的更多信息，参见规则[111.10](./1#cr111-10)。   
...
一个关键字异能，派出一个2/2红色反抗军衍生生物，并将具有该异能的武具贴附于该衍生物上。参见规则[702.163](./7#cr702-163)，“秘罗万岁！”。   
...
五种基本地类别中的一种。任何具有此副类别的地具有异能“{T}：加{G}。”参见规则[305.6](./3#cr305-6)。   
...
一个关键字异能，使牌手从其手上放逐牌，并在将来的回合中使用替代性费用施放之。参见规则[702.143](./7#cr702-143)，“预示”。   
...
一个多人玩法，牌手们会以个人方式来互相展开对抗。参见规则[806](./8#cr806)，“自由竞赛玩法”。   
...
当牌手冒险团中的生物数量为四时，其冒险团满编。参见规则[700.8](./7#cr700-8)。   
...
一个关键字异能，让牌手可以施放连体牌的两边。参见规则[702.102](./7#cr702-102)，“融咒”。   
...
一张堆叠中的连体牌，使用融咒异能施放，或该种牌的复制品。参见规则[702.102](./7#cr702-102)，“融咒”。   
...
一一个关键字动作，使一个生物直到某牌手的下一个回合以前成为被煽惑。参见规则[701.38](./7#cr701-38)，“煽惑”。   
...
一个关键字异能，让一个永久物进入战场带有+1/+1指示物，以及这些指示物可以移动到其他生物上。参见规则[702.58](./7#cr702-58)，“接殖”。   
...
一个关键字异能，让生物可以忽略“召唤失调”规则。参见规则[702.10](./7#cr702-10)，“敏捷”，以及规则[302.6](./3#cr302-6)。   
...
一个关键字异能，让诡局牌以牌面朝下的方式置于统帅区。参见规则[702.106](./7#cr702-106)，“秘案”。   
...
不是所有牌手都应该可以看到牌面的区域。参见规则[400.2](./4#cr400-2)。另参见公开区域。   
...
一个关键字异能，让牌手藏起一张秘密的牌。参见规则[702.75](./7#cr702-75)，“掩蔽”。   
...
一个关键字异能，限制生物如何阻挡。参见规则[702.31](./7#cr702-31)，“马术”。   
...
一个违反游戏规则和/或效应所创造的要求或限制的动作。参见规则[731](./7#cr731)，“处理非法动作”。   
...
印在牌上面一半的图片，对游戏没有效应。参见规则[203](./2#cr203)，“图片”。   
...
在文字栏下方印的信息，对游戏没有效应。参见规则[213](./2#cr213)，“文字栏下方信息”。   
...
于另一个堆叠上的咒语或异能被施放或起动时，施放一个咒语或起动一个异能，指对前一个咒语或异能“作出响应”。参见规则[117.7](./1#cr117-7)。   
...
一个关键字异能，影响一个物件如何对生物或牌手造成伤害。参见规则[702.90](./7#cr702-90)，“侵染”。   
...
一个关键字异能，可以放逐牌手的牌库顶牌。参见规则[702.115](./7#cr702-115)，“摄食”。   
...
牌手能获得的一种称号。一些效应使牌手掌握先制。握有先制的牌手在其掌握先制、及在其维持开始时深入地底城。参见规则[724](./7#cr724)，“先制”。   
...
一个特别用词的条件，检查一个触发式异能是否会触发，并且在将结算时再次检查。参见规则[603.4](./6#cr603-4)。   
...
一个关键字异能，限制一个生物可以怎样被阻挡。参见规则[702.13](./7#cr702-13)，“威吓”。   
...
一个关键字动作，派出一个线索衍生神器。参见规则[701.36](./7#cr701-36)，“探查”。   
...
一个关键字异能，允许牌手弃一张牌来从坟场施放一张牌。参见规则[702.133](./7#cr702-133)，“再起”。   
...
有关一个不再存在于它应在区域的物件，或有关一个不再在游戏中的牌手的信息。信息将抓住该物件在该区域中存在最后一刻的信息，或牌手在离开游戏前最后一刻的信息。参见规则[113.7a](./1#cr113-7a)、[608.2b](./6#cr608-2b)、[608.2g](./6#cr608-2g)以及[800.4h](./8#cr800-4h)。   
...
一个关键字异能，使牌手可以从游戏外将一张课程牌置于其手上，或弃一张牌然后抓一张牌。参见规则[701.45](./7#cr701-45)，“温习”。   
...
当一个永久物从战场移到另一个区域时，或（如果它跃回的话）当它因为其拥有者离开游戏而离开游戏时，它“离开战场”。参见规则[603.6c](./6#cr603-6c)以及[603.10](./6#cr603-10)。   
...
伤害的数量大于或等于生物的防御力。参见规则[120.4a](./1#cr120-4a)、[120.6](./1#cr120-6)、[510.1](./5#cr510-1)以及[704.5g](./7#cr704-5g)。   
...
一个关键字异能，在生物上放置等级指示物。参见规则[702.87](./7#cr702-87)，“升级”。关于职业牌的职业等级异能，参见规则[716](./7#cr716)，“职业牌”。   
...
具有条状文字栏以及三个力量/防御力方格的牌。参见规则[711](./7#cr711)，“升级牌”。   
...
一个只有先锋牌才有的特征。参见规则[212](./2#cr212)，“生命修正”。   
...
每位牌手都具有一定数量的“生命”，表示该牌手的“总生命”。生命可以得到或失去。参见规则[119](./1#cr119)，“生命”。   
...
一个关键字异能，让牌手得到生命。参见规则[702.15](./7#cr702-15)，“系命”。   
...
一种玩法，每位牌手得到一定数量的未开封万智牌产品，并用它们创造自己的套牌。参见规则[100.2](./1#cr100-2)。   
...
在一些多人游戏中使用的可选规则，限制牌手能够影响的事物。参见规则[801](./8#cr801)，“限制影响范围模式”。   
...
一个见于载具上的关键字异能，能够令其在你的回合中变为生物。参见规则[702.161](./7#cr702-161)，“金属生命体”。   
...
一系列可以重复无数次的动作。参见规则[730](./7#cr730)，“进行简化”。   
...
有多种方式输去游戏。参见规则[104](./1#cr104)，“结束游戏”、规则[810.8](./8#cr810-8)（双头巨人玩法的额外规则）、规则[809.5](./8#cr809-5)（皇帝玩法的额外规则）以及规则[903.10](./9#cr903-10)（指挥官玩法的额外规则）。   
...
1. 只有鹏洛客牌具有的牌的一部分。鹏洛客牌的忠诚印在其右下角。参见规则[209](./2#cr209)，“忠诚”。   
...
2. 只有鹏洛客具有的特征。参见规则[306.5](./3#cr306-5)。   
...
费用中具有忠诚符号的起动式异能。参见规则[606](./6#cr606)，“忠诚异能”。   
...
施放（或起动）了创造一个子游戏之咒语（或异能）所在的游戏。参见规则[727](./7#cr727)，“子游戏”。   
...
回合的一部分。第一个行动阶段，或战斗前行动阶段，是回合中的第二个阶段。第二个行动阶段，或战斗后行动阶段，是回合中的第四个阶段。参见规则[505](./5#cr505)，“行动阶段”。   
...
牌手必须于清除阶段中将多余的牌弃掉，直到手牌的数量少于或等于该数字。参见规则[402.2](./4#cr402-2)和[514.1](./5#cr514-1)。   
...
将一个融合牌组中的两张牌翻过来使其背面朝上并组合成一张大号万智牌卡牌。参见规则[701.37](./7#cr701-37)，“融合”。   
...
一种牌，一面具有万智牌的牌面，另一面是一张大号万智牌卡牌的一半。参见规则[712](./7#cr712)，“双面牌”。   
...
一个关键字异能，根据你攻击的对手数量来强化一个进攻生物。参见规则[702.121](./7#cr702-121)，“乱斗”。   
...
一种躲避式异能，可以让生物不能被单一生物阻挡。参见规则[702.111](./7#cr702-111)，“威慑”。   
...
一个关键字异能，使你的较大生物在与较小生物一同攻击时强化后者。参见规则[702.134](./7#cr702-134)，“训导”。   
...
牌或衍生物可能会与永久物结聚，组合成结聚永久物。这个结聚永久物会由多于一张的牌或衍生物所代表。参见规则[728](./7#cr728)，“与永久物结聚”。   
...
磨数张牌指，牌手将该数量的牌从牌库顶置于其坟墓场。参见规则[701.13](./7#cr701-13)。   
...
一个关键字异能，如果该牌是回合中你所抓的第一张牌，便允许你用较低的费用施放它。参见规则[702.94](./7#cr702-94)，“奇迹”。   
...
一个关键字异能，派出若干已横置且正进行攻击的红色战士衍生生物，且在下一个结束步骤开始时牺牲之。参见规则[702.181](./7#cr702-181)，“动员”。   
...
两种双面牌中的一种。模式双面牌的两面可以任选一面朝上使用，但它不能转化。参见规则[712](./7#cr712)，“双面牌”。   
...
如果某咒语或异能以项目列表的格式提供了两种或以上的选择，且以指示牌手从这些选项中选择数项的字样开头，例如“选择一项～”，此咒语或异能便具有模式。参见规则[700.2](./7#cr700-2)。   
...
有饰装的生物是指其上有指示物、或佩带有武具、或被一个由其操控者操控的灵气所结附的生物。参见规则[700.9](./7#cr700-9)。   
...
一个关键字异能，使得永久物进战场时带有+1/+1指示物，且能将这些指示物移动到其他神器生物上。参见规则[702.43](./7#cr702-43)，“套件”。   
...
牌手能获得的一种称号。一些效应使牌手成为君主。君主在其结束步骤开始时抓一张牌。对君主造成战斗伤害可以从该牌手上夺取该称号。参见规则[723](./7#cr723)，“君主”。   
...
一个关键字动作，在生物上放置+1/+1指示物，并使其成为蛮化。（译注：中文版翻译中，“当...成为蛮化时”简略译为“当...蛮化时”，有可能引起混淆。）参见规则[701.31](./7#cr701-31)，“蛮化”。   
...
因一个生物的蛮化起动式异能已经结算，而赋予它的一种称号。（译注：中文版翻译中，“当...成为蛮化时”简略译为“当...蛮化时”，有可能引起混淆。）参见规则[701.31](./7#cr701-31)，“蛮化”。   
...
一个关键字异能，使你可以已转换地施放某些牌。参见规则[702.162](./7#cr702-162)，“远超所见”，及规则[701.50](./7#cr701-50)，“转换”。   
...
五种基本地类别中的一种。任何具有此副类别的地都具有异能“{T}：加{R}。”参见规则[305.6](./3#cr305-6)。   
...
从一个物件上移除指示物，并将其放置在另一个物件上。参见规则[122.5](./1#cr122-5)。   
...
执行“再调度”是指不接受一副可能的起手牌，并用一副新的起手牌代替之。参见规则[103.5](./1#cr103-5)。   
...
一个使用合变关键字异能施放的生物咒语。于其结算时，如果其目标的生物合法，其与该目标生物结聚。所成的生物具有最顶上组件的所有特征以及每个组件的异能。参见规则[702.140](./7#cr702-140)，“合变”，以及规则[728](./7#cr728)，“与永久物结聚”。   
...
一个特征，也是牌的一部分。牌的名称印在它的左上角。参见规则[201](./2#cr201)，“名称”。   
...
与白昼一起，均是游戏可以具有的称号。参见规则[729](./7#cr729)，“白昼与黑夜”，与规则[702.145](./7#cr702-145)，“昼形与夜形”。   
...
一种异能，见于一些双面牌的背面上。具昼形与夜形异能的牌，在白昼时正面朝上，在黑夜时背面朝上。参见规则[702.145](./7#cr702-145)，“昼形与夜形”，与规则[729](./7#cr729)，“白昼与黑夜”。   
...
一个关键字异能，让生物突然加入战斗。参见规则[702.49](./7#cr702-49)，“忍术”。   
...
一张分为两部分（且其中一部分是嵌在文字栏左面）的牌，其副特征包括预兆此咒语类别。。参见规则[720](./7#cr720)，“预兆牌”。   
...
只作一件事且没有持续的效应。参见规则[610](./6#cr610)，“一次性效应”。另参见持续性效应。   
...
在牌手决定不再调度之后，其开始游戏时手上的牌。参见规则[103.5](./1#cr103-5)。   
...
多人游戏中可以使用的一些额外规则。参见规则[800.2](./8#cr800-2)。   
...
一个关键字异能，让生物能够持续变大。参见规则[702.107](./7#cr702-107)，“延生”。   
...
如果一个物件不在任何游戏区域中，该物件在“游戏之外”。参见规则[400.11](./4#cr400-11)。   
...
（作为游戏的一部分）拥有一张牌、永久物、衍生物或咒语的牌手。参见规则[108.3](./1#cr108-3)、[110.2](./1#cr110-2)、[111.2](./1#cr111-2)和[112.2](./1#cr112-2)。   
...
一个关键字异能，在指挥官玩法中使两个传奇生物（而不是一个）成为你的指挥官。“与[名称]拍档”是此异能的特别形式，它即使在指挥官玩法之外也能起作用，能帮助两张牌同时抵达战场。参见规则[702.124](./7#cr702-124)，“拍档”以及规则[903](./9#cr903)，“指挥官”。   
...
一些牌提及你冒险团中的生物数量。牌手的冒险团由僧侣、浪客、战士和法术师组成，每种类别至多只计入一个。参见规则[700.8](./7#cr700-8)。   
...
在拥有优先权时不执行动作（例如施放咒语或起动异能）。参见规则[117](./1#cr117)，“时机和优先权”。   
...
如果游戏中的每位牌手（从任意一人开始）在得到优先权时都不执行动作，所有牌手便“依次让过”。参见规则[117](./1#cr117)，“时机和优先权”。   
...
战场上的牌或衍生物。参见规则[110](./1#cr110)，“永久物”。   
...
可以放进战场的牌。参见规则[110.4a](./1#cr110-4a)。   
...
结算时会作为永久物进入战场的咒语。参见规则[110.4b](./1#cr110-4b)。   
...
一个关键字异能，可以将生物从坟场返回战场。参见规则[702.79](./7#cr702-79)，“留存”。   
...
永久物可能具有的状态。默认状态下，永久物都是已跃回。已跃离的永久物被视为其不存在。参见规则[110.5](./1#cr110-5)和规则[702.26](./7#cr702-26)，“时间跳跃”。（“跃离区”在较老版本的规则中是一个游戏区域。）   
...
一个关键字异能，使得永久物有时被视为其不存在。参见规则[702.26](./7#cr702-26)，“时间跳跃”。   
...
五种基本地类别中的一种。任何具有此副类别的地都具有异能“{T}：加{W}。”参见规则[305.6](./3#cr305-6)。   
...
竞逐时空休闲式玩法需要的至少十张时空牌组成的套牌。参见规则[901.3](./9#cr901-3)。   
...
竞逐时空休闲式玩法需要的特制六面骰。参见规则[901.3](./9#cr901-3)。   
...
一种休闲式玩法，时空牌和异象牌为游戏带来额外的异能和随机性。参见规则[901](./9#cr901)，“竞逐时空”。   
...
鹏洛客符号出现在竞逐时空休闲式玩法中使用的时空骰上。参见规则[107.11](./1#cr107-11)。   
...
游戏中的人之一。参见规则[102](./1#cr102)，“牌手”。   
One of the people in the game. See rule 102, “Players.”

----
### <span id='Plot'>Plot</span> / <span id='设谋'>设谋</span>
一个关键字异能，允许牌手从手上放逐牌并在之后的回合中施放，且不需支付其法术力费用。参见规则[702.170](./7#cr702-170)，“设谋”。   
...
以设谋特殊动作放逐的牌成为已设谋。其他效应亦能令一张已放逐的牌成为已设谋。参见规则[702.170](./7#cr702-170)，“设谋”。   
...
可以给予牌手的一种指示物。参见规则[122](./1#cr122)，“指示物”，和规则[704.5c](./7#cr704-5c)。   
...
1. 只有生物牌具有的牌的一部分。生物牌的力量印在其右下角斜线之前。参见规则[208](./2#cr208)，“力量/防御力”。   
...
魔力石衍生物是具有“{T}：加{C}。此法术力不能用来施放非神器咒语。”的无色魔力石衍生神器。欲知关于预定义衍生物的更多信息，参见规则[111.10](./1#cr111-10)。   
...
使用“优先权”系统来决定任一时刻哪位牌手可以执行动作。参见规则[117](./1#cr117)，“时机和优先权”。   
...
对于任意数量的已有指示物的牌手和/或永久物，其上每种指示物都给予一个额外的指示物。参见规则[701.27](./7#cr701-27)，“增殖”。   
...
一个异能，允许一张试作牌使用其第二组特征来施放。参见规则[718](./7#cr718)，“试作牌”，及规则[702.160](./7#cr702-160)，“试作”。   
...
一张分为两部分（且其中一部分是嵌在类别栏下方）的牌。参见规则[718](./7#cr718)，“试作牌”。   
...
一个关键字异能，有时允许咒语以替代性费用施放。参见规则[702.76](./7#cr702-76)，“伺机”。   
...
牌手可以具有的一种指示物，会导致牌手在其战斗前的行动阶段磨牌，然后每以此法磨掉一张非地牌，便失去1点生命并移去一个拉德指示物。参见规则[122](./1#cr122)，“指示物”，及规则[726](./7#cr726)，“拉德指示物”。   
...
一个关键字异能，让生物在战斗中更强。参见规则[702.23](./7#cr702-23)，“狂暴”。   
...
一个关键字异能，见于一些法术力费用中含有{X}的生物牌上。该生物进战场时上面有X个+1/+1指示物，且如果X等于或大于5，你抓一张牌。参见规则[702.156](./7#cr702-156)，“贪食”。   
...
一个关键字异能，让生物可以阻挡具有飞行的攻击生物。参见规则[702.17](./7#cr702-17)，“延势”。另参见飞行。   
...
一个见于传纪上的关键字异能，允许其操控者选择从哪个章节开始。参见规则[702.155](./7#cr702-155)，“跳读”。   
...
一个关键字异能，让武具生物暂时不再是生物，且贴附于另一个生物上。参见规则[702.151](./7#cr702-151)，“重配”。   
...
一种替代性效应，让对一个生物、鹏洛客、或牌手造成的伤害改为对另一个生物、鹏洛客、或牌手造成。参见规则[614.9](./6#cr614-9)。   
...
一种异能，根据先前咒语或异能结算过程中所作的动作而决定是否触发。参见规则[603.12](./6#cr603-12)。   
...
牌的文字栏内括号中的斜体字，总结对该牌生效的一条规则，但不是正式规则叙述且对游戏没有效应。参见规则[207.2](./2#cr207-2)。   
...
一些特定的事件将造成攻击或阻挡生物，或正被被攻击的鹏洛客，被“移出战斗”。一个被移出战斗的永久物对该战斗阶段没有更多的参与。参见规则[506.4](./5#cr506-4)。   
...
一个关键字异能，使生物对牌手造成过战斗伤害之后变得更强。参见规则[702.112](./7#cr702-112)，“铭勇”。   
...
因永久物的铭勇异能，而赋予它的一种称号。参见规则[702.112](./7#cr702-112)，“铭勇”。   
...
持续性效应的一种，注意某特定事件将发生，并且将该事件完全或部分的用不同的事件替代。参见规则[614](./6#cr614)，“替代性效应”。   
...
一个强制一个或数个生物攻击或阻挡的效应。参见规则[508.1d](./5#cr508-1d)以及[509.1c](./5#cr509-1c)。   
...
当堆叠顶端的咒语或异能“结算”时，它的叙述被执行且它具有其效应。参见规则[608](./6#cr608)，“结算咒语和异能”。   
...
另一个咒语或异能已经在堆叠上时，施放一个瞬间咒语或起动一个异能。参见规则[117.7](./1#cr117-7)。   
...
一个阻止一个或数个生物攻击或阻挡的效应。参见规则[508.1c](./5#cr508-1c)以及[509.1b](./5#cr509-1b)。   
...
一个关键字异能，让牌手从其坟墓场中施放牌。参见规则[702.81](./7#cr702-81)，“追溯”。   
...
将一张牌在简短的事件内给所有牌手看。参见规则[701.16](./7#cr701-16)，“展示”。   
...
一个关键字异能，使牌手在某些生物进战场时选择其具有敏捷或是带有一个+1/+1指示物。参见规则[702.136](./7#cr702-136)，“起事”。   
...
一个关键字异能，可以让牌手从其牌库中施放额外的牌且不需支付费用。参见规则[702.60](./7#cr702-60)，“涟动”。   
...
角色是无色结界衍生物。每一种角色都具有灵气／角色的副类别，以及“结附于生物”的异能。如果某个永久物其上结附有由同一位牌手操控的数个角色，则除了具最近之时间印记者外，所有其他这类角色都会被置入其拥有者的坟墓场。参见规则[303.7](./3#cr303-7)及规则[111.10j-r](./1#cr111-10j)。   
...
掷一颗二十面的骰子。类似地，d4是四面的骰子，d6是六面的骰子，依此类推。参见规则[706](./7#cr706)，“掷骰”。   
...
将一个你操控的永久物移到其拥有者的坟墓场。参见规则[701.17](./7#cr701-17)，“牺牲”。   
...
一个生物可在其乘驾异能结算时得到的称号。参见规则[702.171](./7#cr702-171)，“乘驾”。   
...
一个关键字异能，让你可以从你的坟墓场中放逐一张生物牌来在一个生物上放置+1/+1指示物。参见规则[702.97](./7#cr702-97)，“食腐”。   
...
在无须双方牌手特别指出每个选择的情况下，让大家自然可以理解并让游戏自然通过这些游戏选择（作出动作或让过优先权）。参见规则[730](./7#cr730)，“进行简化”。   
...
一个关键字异能，让永久物或牌手避免成为目标。参见规则[702.18](./7#cr702-18)，“帷幕”。   
...
将套牌（游戏开始前）或牌库（游戏过程中）中的牌随机化。参见规则[103.3](./1#cr103-3)及规则[701.20](./7#cr701-20)。   
...
使用“略过”一词的效应为替代性效应。“略过”一词表示哪个事件、步骤、阶段或回合将被什么都不发生替代。参见规则[614](./6#cr614)，“替代性效应”。   
...
一个关键字异能，限制一个生物能够如何被阻挡。参见规则[702.118](./7#cr702-118)，“潜匿”。   
...
一般只对永久物有关的超类别。参见规则[205.4](./2#cr205-4)，“超类别”。   
...
雪境法术力符号{S}表示一点可以由雪境来源所产生的法术力所支付的费用。它也可以表示用于支付费用的、由雪境来源所产生的法术力。参见规则[107.4h](./1#cr107-4h)。   
...
1. 一个案件可以获得的称号，允许案件的最后一个异能影响游戏。参见规则[719](./7#cr719)，“案件牌”。   
1. A designation a Case may have, allowing its last ability to affect the game. See rule 719, “Case Cards.”

2. 一个案件的关键字异能，在案件具有已侦结此称号时影响游戏。参见规则[702.169](./7#cr702-169)，“侦结”。   
...
一个关键字异能，让牌手将其坟墓场中的牌移回其手上。参见规则[702.46](./7#cr702-46)，“转生”。   
...
牌手可以进行且不使用堆叠的动作。参见规则[116](./1#cr116)，“特殊动作”。   
...
异能的一种。咒语异能为在瞬间或法术咒语结算时其叙述所表达的异能。参见规则[113.3a](./1#cr113-3a)。   
...
一个关键字异能，让牌手将牌的规则叙述附加到另一个咒语上。参见规则[702.47](./7#cr702-47)，“通联”。   
...
在一张牌上有两张牌面。参见规则[709](./7#cr709)，“连体牌”。   
...
一个关键字异能，让牌手几乎无法响应一个咒语。参见规则[702.61](./7#cr702-61)，“转瞬”。   
...
一个见于某些具有模式之咒语上的关键字，允许你选择一个或数个模式，并需要为这些模式支付额外费用。参见规则[702.172](./7#cr702-172)，“追欢”。   
...
一个关键字异能，使生物进战场时派出其复制品。参见规则[702.157](./7#cr702-157)，“小队”。   
...
在牌手将其备牌放在一边之后，其余的套牌便成为其起始套牌。参见规则[103.2a](./1#cr103-2a)。   
...
牌手在游戏开始时抓牌的数量。在大多数游戏中，每位牌手的起手牌数量为七。参见规则[103.5](./1#cr103-5)。   
...
牌手在游戏开始时的生命总值。在大多数游戏中，每位牌手的起始总生命为20。参见规则[103.4](./1#cr103-4)。   
...
选择进行游戏第一个回合的牌手。参见规则[103.1](./1#cr103-1)。   
...
在使用队伍共享回合模式中，选择进行游戏第一个回合的队伍。参见规则[103.1](./1#cr103-1)。   
...
一个当游戏状态符合而不是触发事件发生时触发的触发式异能。参见规则[603.8](./6#cr603-8)。   
...
每当特定条件符合时自动发生的游戏动作。参见规则[704](./7#cr704)，“状态动作”。   
...
一种异能。静止式异能时刻都生效而不是被起动或触发。参见规则[113](./1#cr113)，“异能”，以及规则[604](./6#cr604)，“处理静止式异能”。   
...
一个永久物的物理状态。参见规则[110.5](./1#cr110-5)。   
...
一个置于物件或牌手上的标示物，影响其特征或与规则或效应互动。参见规则[123](./1#cr123)，“贴纸”。   
...
增幅异能的一种变化，可以在咒语上贴上贴纸并给予牌手门票指示物。参见规则[702.33h](./7#cr702-33h)。   
...
贴纸的集合，能够在Unfinity系列补充包的贴纸页上找到。参见规则[123](./1#cr123)，“贴纸”。   
...
非正式用语，指除非一个生物在牌手最近的一个回合开始时便已经操控它，否则该牌手不能用该生物进行攻击或起动它包含横置符号或重置符号的起动式异能。参见规则[302.6](./3#cr302-6)。另参见敏捷。   
...
每位牌手都是魔王的自由竞赛游戏。参见规则[806](./8#cr806)，“自由竞赛模式”和规则[904](./9#cr904)，“魔王”。   
...
一个关键字动作，让你在生物上放置+1/+1指示物。参见规则[701.35](./7#cr701-35)，“支援”。   
...
一个关键字异能，提供使用一张牌的其他途径。参见规则[702.62](./7#cr702-62)，“延缓”。如果一张牌在放逐区、具有延缓、并且具有计时指示物，则该牌“已延缓”。   
...
五种基本地类别中的一种。任何具有此副类别的地都具有异能“{T}：加{B}。”参见规则[305.6](./3#cr305-6)。   
...
一个永久物可能具有的状态。参见规则[110.5](./1#cr110-5)和规则[701.21](./7#cr701-21)，“横置和重置”。另参见未横置。   
...
事先对一个咒语或异能将影响的物件或牌手作出的选择。参见规则[115](./1#cr115)，“目标”。   
...
牌的一部分。文字栏印在牌的下面一半，包括该牌的规则叙述、提示文字、和背景叙述。参见规则[207](./2#cr207)，“文字栏”。   
...
一个徽记，在魔戒引诱你时被创造。参见规则[701.52](./7#cr701-52)，“魔戒引诱你”。   
...
一个关键字动作，使牌手选择一个其操控的生物作为传奇持戒人，并创造一个名为魔戒的徽记。参见规则[701.52](./7#cr701-52)，“魔戒引诱你”。   
...
从任意数量由你操控且其上有计时指示物的永久物和/或放逐区内由你拥有且其上有计时指示物之已延缓的牌上放置或移去一个计时指示物。参见规则[701.54](./7#cr701-54)，“时间旅行”。   
...
用来决定同一层或副层中持续性效应生效顺序的系统。参见规则[613.7](./6#cr613-7)。另参见从属关系。   
...
一个标记，用来表示任何不用牌来表示的永久物。参见规则[111](./1#cr111)，“衍生物”。   
...
在一些奥德赛环境牌的左上角有墓碑符号，它对游戏没有影响。参见规则[107.9](./1#cr107-9)。   
...
牌手实际需要为施放咒语或起动异能所支付的费用；法术力费用、起动费用、或替代性费用，加上所有增加的费用（包括额外费用）并减去所有减少的费用。参见规则[601.2f](./6#cr601-2f)。   
...
一个关键字异能，使牌手因具有此异能的生物造成的战斗伤害获得中毒指示物。参见规则[702.164](./7#cr702-164)，“下毒”。   
...
一个关键字异能，让牌手可以从其牌库中搜寻一张代替的生物牌。参见规则[702.71](./7#cr702-71)，“易形”。   
...
将一张双面牌翻转从而让其另一面朝上。参见规则[701.28](./7#cr701-28)，“转化”。   
...
两种双面牌中的一种。转化式双面牌的默认使用其正面，但能以某种方式转化到其背面。参见规则[712](./7#cr712)，“双面牌”。   
...
一个关键字异能，让牌手从其牌库中搜寻一张代替的牌。参见规则[702.53](./7#cr702-53)，“易质”。   
...
珍宝衍生物是具有“{T}，牺牲此神器：加一点任意颜色的法术力。”的无色衍生神器。欲知关于预定义衍生物的更多信息，参见规则[111.10](./1#cr111-10)。   
...
一个关键字异能，允许对手选择让生物进战场时具有+1/+1指示物或一个额外异能。参见规则[702.104](./7#cr702-104)，“致敬”。   
...
一个多人玩法，在两人共享总生命且同时进行回合的队伍之间展开。参见规则[801](./8#cr801)，“双头巨人玩法”。   
...
在一些预知将来版本的卡牌左上角有类别符号，它们对游戏没有影响。参见规则[107.10](./1#cr107-10)。   
...
一种循环异能。参见规则[702.29](./7#cr702-29)，“循环”。   
...
一旦一个攻击生物没有被宣告任何阻挡者，除非一个效应导致它被阻挡。它在从战斗中被移除或战斗阶段结束两者中先发生的情况未知，一直保持是未被阻挡的生物。参见规则[509](./5#cr509)，“宣告阻挡者步骤”。   
...
一个关键字异能，让牌手将生物牌从坟墓场中移回战场上。参见规则[702.84](./7#cr702-84)，“破坟”。   
...
一个永久物可能具有的默认状态。参见规则[110.5](./1#cr110-5)和规则[710](./7#cr710)，“倒转牌”。另参见倒转。   
...
一个关键字异能，让生物进入战场时具有+1/+1指示物，并且如果它具有+1/+1指示物则防止其阻挡。参见规则[702.98](./7#cr702-98)，“脱缰”。   
...
一个永久物可能具有的默认状态。参见规则[110.5](./1#cr110-5)和规则[701.21](./7#cr701-21)，“横置和重置”。另参见已横置。   
...
回合的一部分。该步骤是开始阶段的第二个步骤。参见规则[503](./5#cr503)，“维持步骤”。   
...
指代一种曾经的再调度方式的非正式用词。使用温哥华再调度方式时，牌手再调度时将其手牌洗入其牌库，然后少抓一张牌。在决定不再次再调度之后，已执行过再调度的牌手查看其牌库顶牌，并能够选择将其置于牌库底。要查看当前的再调度规则，参见规则[103.5](./1#cr103-5)。   
...
一个关键字异能，限制一个永久物在战场上的时间。参见规则[702.63](./7#cr702-63)，“消逝”。   
...
决定一盘多人游戏风格的一组规则集合。参见规则[800.2](./8#cr800-2)。   
...
一个神器副类别。载具可以变成神器生物。参见规则[301](./3#cr301)，“神器”，以及规则[702.122](./7#cr702-122)，“搭载”。   
...
一种标记，用来记录牌手当前在地城牌的哪个房间中。参见规则[309](./3#cr309)，“地城”。   
...
深入地城异能的一种变化形式，使牌手将具[特性]的地城牌带入游戏，或移动牌手的进度标记。参见规则[701.46](./7#cr701-46)，“深入地城”。   
...
一个关键字动作，可以将地城牌从游戏外带入游戏，或移动牌手的进度标记。参见规则[701.46](./7#cr701-46)，“深入地城”。   
...
一个关键字异能，让生物进行攻击不需横置。参见规则[702.20](./7#cr702-20)，“警戒”。   
...
一个见于景点牌上的关键字异能。它在你掷骰造访景点并获得特定结果时提供效应。参见规则[702.159](./7#cr702-159)，“造访”。   
...
一些牌会指示牌手对给定的选项进行投票。参见规则[701.32](./7#cr701-32)，“投票”。   
...
尸行者衍生物是名为尸行者的2/2黑色灵俑衍生生物。欲知关于预定义衍生物的更多信息，参见规则[111.10](./1#cr111-10)。   
...
一个触发式异能，可以反击指定具守护异能之永久物的咒语或异能。参见规则[702.21](./7#cr702-21)，“守护”。   
...
有多种方法可以取得游戏的胜利。参见规则[104](./1#cr104)，“结束游戏”，以及规则[810.8](./8#cr810-8)（双头巨人游戏的额外规则）和规则[809.5](./8#cr809-5)（皇帝玩法的额外规则）。   
...
一个状态动作，让所有具有普世超类别的永久物，除了拥有普世超类别时间最短的一个以外，皆置入其拥有者的坟墓场。参见规则[704.5k](./7#cr704-5k)。   
...
指一个物件的操控者、它即将的操控者（如果牌手正准备施放或起动它），或它的拥有者（如果没有操控者）。参见规则[109.5](./1#cr109-5)。   
