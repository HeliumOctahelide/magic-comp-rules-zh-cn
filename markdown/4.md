...
<b id='cr400-7f'>400.7f</b> 如果灵气与它所结附的永久物离开战场的同时进入坟墓场，或灵气因未贴附永久物而作为状态动作置入其拥有者的坟墓场，因受结附的永久物离开战场而触发的触发式异能，可以在其拥有者的坟墓场中找到各结附于该永久物的灵气所成为的新物件。（参见规则[704.5m](/cr/7/#cr704-5m)。）   
...
<b id='cr400-7h'>400.7h</b> 如果一个效应允许一张非地牌被施放，该效应的其他部分可以在该牌因以此法施放而移动到堆叠上并成为新物件后找到该物件。   
...
<b id='cr400-7i'>400.7i</b> 如果一个效应允许一张地牌被使用，该效应的其他部分可以在该地牌因以此法使用而移动到战场并成为新物件后找到该物件。   
...
<b id='cr401-7'>401.7.</b> 如果一个效应让牌手把牌放在某牌库“顶第N张”，且该牌库的牌少于N张，则该牌手将该牌放在牌库底。   
...
<b id='cr402-1'>402.1.</b> 手牌指牌手已经抓取的牌。其他效应也可能会将牌置入牌手的手牌。在游戏开始时，每位牌手各抓等同于起手牌张数的牌，一般为七张。（参见规则[103](/cr/1/#cr103)，“开始游戏”。）   
...
<b id='cr405-5'>405.5.</b> 当所有牌手连续让过时，堆叠最顶端的（最后进入的）咒语或异能结算。如果所有牌手皆让过且堆叠为空，当前阶段或步骤结束且下一个开始。   
...
<b id='cr406-3a'>406.3a</b> 牌面朝下放逐的牌没有特征，但放逐该牌的咒语或异能可能会允许该牌从放逐区使用。除非该牌被面朝下地施放（参见规则[708.4](/cr/7/#cr708-4)），在牌手宣告使用该牌之前立即翻回正面。（参见规则[601.2](/cr/6/#cr601-2)）   
