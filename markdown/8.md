...
<b id='cr800-6'>800.6.</b> 在多人游戏中，牌手第一次执行的再调度不会计入其应置于其牌库底的牌张数量，也不会计入其可以执行再调度的次数。第一次再调度之后的再调度会正常计入该数量。   
...
<b id='cr801-13b'>801.13b</b> 如果咒语或异能创造了一个将防止某来源将要造成之伤害的效应，则它只能影响该咒语或异能操控者影响范围内的来源。如果咒语或异能创造了一个将防止对一个永久物或牌手造成之伤害的效应，则它只能影响该咒语或异能操控者影响范围内的永久物或牌手。如果咒语或异能创造了一个将防止伤害的效应，但既没有注明来源，也没有注明将要被防止伤害者，则只有当伤害来源与将要受到该伤害者同时在该咒语或异能的操控者影响范围内时，该效应才会防止伤害。   
...
<b id='cr801-14'>801.14.</b> 如果一个效应叙述一位牌手赢得游戏，则改为所有该牌手影响范围内的对手输掉游戏。   
...
<b id='cr801-15'>801.15.</b> 如果一个咒语或异能的效应叙述当前游戏为平手，则只有该咒语或异能的操控者以及在该牌手影响范围之内的所有牌手会以平手结束本盘游戏。他们离开游戏。所有其余牌手继续进行游戏。   
...
<b id='cr802-3'>802.3.</b> 于攻击牌手宣告攻击生物时，其为每个攻击生物各选择攻击的防御牌手、由防御牌手操控的鹏洛客、或是由防御牌手防卫的战役。参见规则[508](/cr/5/#cr508)，“宣告攻击者步骤”。   
...
<b id='cr807-4d'>807.4d</b> 收到回合标记的牌手，如果其左起三个座位中有牌手持有回合标记，则不能开始其回合。在此情形下，该牌手须等待直到其左起第四个座位的牌手得到该回合标记。   
...
<b id='cr809-5b'>809.5b</b> 如果皇帝输掉了游戏，则皇帝所在的队伍输掉游戏。   
...
<b id='cr810-8a'>810.8a</b> 牌手以队伍赢得或输掉游戏，而不是个人。如果队伍中的任一位牌手输掉了游戏，整个队伍输掉此盘游戏。如果队伍中的任一位牌手赢得了游戏，整个队伍赢得此盘游戏。如果一个效应叙述一位牌手不能赢得游戏，则该牌手所在队伍不会赢得游戏。如果一个效应叙述一位牌手不能输掉游戏，则该牌手所在队伍不会输掉游戏。   
...
例如：在一盘双头巨人游戏中，一位牌手操控超凡入圣，其部分叙述为“你不因总生命为0或更少而输掉此盘游戏。”如果该牌手所在队伍的总生命为0或更少，该队伍也不会输掉此盘游戏。   
...
例如：在一盘双头巨人游戏中，一位牌手在其牌库没有牌时必须抓一张牌。该牌手输掉此盘游戏，所以该牌手的队伍亦输掉此盘游戏。   
...
例如：在一盘双头巨人游戏中，一位牌手操控白金天使，其叙述为“你这盘游戏不会输，对手也不会赢。”则只要白金天使在战场，该牌手和其队友都不会输掉此盘游戏，且对方队伍的牌手也都不会赢得此盘游戏。   
...
<b id='cr810-11'>810.11.</b> 双头巨人玩法也适用于由两位以上且相同数量牌手组成的队伍之间的游戏。从两位牌手算起，队伍中每多出一位牌手，队伍的起始总生命便增加15，输掉游戏所需的中毒指示物便增加5。（这些玩法称为三头巨人或四头巨人，依此类推。）   
